...
tsne3d = TSNE(
    n_components=TSNE_hyperparams["n_components"],
...
clf = SVC(
    random_state=SVM_hyperparams["random_state"],
...
grid = RandomizedSearchCV(
    estimator=clf, param_distributions=param_dist, n_jobs=-1, cv=cv, n_iter=10
)
