...
argparser.add_argument(
    "--file", help="file containing mesh data", type=str, required=True
)
...
plot_points = (
    n_points + 1
)  # Need 1 more than the points used for the SVM prediction
...
xx, yy, zz = np.meshgrid(
    np.linspace(x_min, x_max, plot_points),
...
alphas = [0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.1]
...
fig.legend(
    handles, legend_labels, fontsize=60, loc="center right", markerscale=2
)
