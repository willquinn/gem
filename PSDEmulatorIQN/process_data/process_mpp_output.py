...
parser.add_argument(
    "-i", "--input", type=str, required=True, help="Input MPP file(s)"
)
parser.add_argument(
    "-o",
    "--output",
    default=f"data/{GED_NAME}_mpp_output_default.json",
    type=str,
...
parser.add_argument(
    "-pet",
    "--pet_file",
    default=f"data/{GED_NAME}_pet_default.csv",
    type=str,
    help="Name of output file",
)
parser.add_argument(
...
parser.add_argument(
    "-dt",
    "--drift_time_file",
    default=f"data/{GED_NAME}_drift_time_map.dat",
    type=str,
...
def main():
    ...
    data_dict = {
        f"{i}": []
        for i in ["x", "y", "z", "r", "t", "dts", "E", "Esum", "ievt_n"]
    }
    ...
    df_data = (
        df_data.explode(["x", "y", "z", "r", "E", "dts", "Esum", "ievt_n"])
        .reset_index()
        .drop(columns=["index"])
    )
